...
Todo.create(title: "Ménage", completed: false)
Todo.create(title: "Vaisselle", completed: false)
Todo.create(title: "Linge", completed: false)
Todo.create(title: "Facture", completed: false)
